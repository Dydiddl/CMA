        ...
        def split_pdf():
            try:
                ...
                for section in toc_structure.get("sections", []):
                    ...
                    with open(section_file, 'wb', encoding=\'utf-8\', newline=\'\', newline='', encoding='utf-8', newline='') as output_file:
    ...
    async def _save_results_async(self, output_dir: Path, results: Dict[str, Any]):
        ...
        async def save_json():
            try:
                ...
                async with aiofiles.open(output_file, 'w', encoding='utf-8', newline=\'\', encoding=\'utf-8\', newline=\'\', newline='', encoding='utf-8', newline='') as f:
