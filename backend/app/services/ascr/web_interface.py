...
<body>
    ...
    <script>
        ...
        # 템플릿 파일 저장
        with open(self.template_dir / "index.html", "w", encoding="utf-8", newline=\'\', encoding=\'utf-8\', newline=\'\', newline='', encoding='utf-8', newline='') as f:
...
async def serve_static_files(file_path: str):
    ...
    return StreamingResponse(
        open(static_file, "rb", encoding=\'utf-8\', newline=\'\', newline='', encoding='utf-8', newline=''),
