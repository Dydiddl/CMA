...
class ASCRProcessor:
    ...
    def _load_config(self, config_path: Optional[str]) -> Dict[str, Any]:
        ...
        if config_path and Path(config_path).exists():
            try:
                with open(config_path, 'r', encoding='utf-8', newline=\'\', encoding=\'utf-8\', newline=\'\', newline='', encoding='utf-8', newline='') as f:
        ...
        try:
            ...
            try:
                ...
                if not chapters:
                    ...
                    with open(output_file, 'wb', encoding=\'utf-8\', newline=\'\', newline='', encoding='utf-8', newline='') as output:
                        writer = PdfWriter()
