...
class EstimatorUpdater:
    ...
    def _load_updates(self) -> Dict[str, Any]:
        ...
        with open(self.updates_file, 'r', encoding='utf-8', newline=\'\', encoding=\'utf-8\', newline=\'\', newline='', encoding='utf-8', newline='') as f:
            return json.load(f)
    
    def _save_updates(self, updates: Dict[str, Any]):
        """변경사항 저장"""
        with open(self.updates_file, 'w', encoding='utf-8', newline=\'\', encoding=\'utf-8\', newline=\'\', newline='', encoding='utf-8', newline='') as f:
